...
//     cardElement.querySelector('.element__img').textContent = name;
//     cardElement.querySelector('.element__title').textContent = link;
  
//     cardContainer.prepend(cardElement);
//   }
  
//   // Вызываем функцию arrayCard, чтобы отобразить карточки на странице
//   arrayCard();
